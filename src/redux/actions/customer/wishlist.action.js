import { loadWishlist, addProductToWishlist, removeProductFromWishlist, clearWishlist } from "../../../services/customer/wishlist.service";
...
export function loadWishlistAsync() {
    ...
    function success(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.WISHLIST_ITEMS_LOAD_SUCCESS, payload
        };
    }

    function failure(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.WISHLIST_ITEMS_LOAD_FAILURE, payload
        };
    }  
}
...
export function addProductToWishlistAsync(productId, qty) {
    ...
    function success(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.ADD_ITEM_TO_WISHLIST_SUCCESS, payload
        };
    }

    function failure(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.ADD_ITEM_TO_WISHLIST_FAILURE, payload
        };
    }
}
...
export function removeProductFromWishlistAsync(productId) {
    ...
    function success(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.DELETE_ITEM_FROM_WISHLIST_SUCCESS, payload
        };
    }

    function failure(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.DELETE_ITEM_FROM_WISHLIST_FAILURE, payload
        };
    }
}
...
export function clearWishlistAsync() {
    ...
    function failure(payload) {
        return {
            type: WISHLIST_ACTION_TYPES.CLEAR_WISHLIST_FAILURE, payload
        };
    }
}